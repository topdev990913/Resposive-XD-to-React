...
const HighLightMiddleExpertWhite = () => {
    return (
        <div className="HighLightMiddle_out">
            ...
            <div className="d-flex align-items-center">
                <div className="HighLightMiddle_2_white">
                    melih1905
                </div>
            ...
            <div className="HighLightMiddle_3_expert_white">
                Membership Date 22.04.2022
            </div>
        </div>
    );
};
export default HighLightMiddleExpertWhite;
