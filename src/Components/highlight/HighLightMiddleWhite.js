...
const HighLightMiddleWhite = () => {
    return (
        <div className="HighLightMiddle_out">
            <div className="HighLightMiddle_1_white">
                %63.2
            </div>
            <div className="d-flex">
                <div className="HighLightMiddle_2_origin_white">
                    melih1905
                </div>
            ...
            <div className="HighLightMiddle_3_white">
                <span className="highlight_number_white">2,655</span> People subscribed
            </div>
        </div>
    );
};
export default HighLightMiddleWhite;
