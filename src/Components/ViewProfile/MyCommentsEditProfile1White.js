...
const MyCommentsEditProfile1White = ({ checkedSubComment, setCheckedSubComment }, { checkedBall, setCheckedBall }) => {
    return (
        <div className="VP_MC_EP_out_white">
            ...
            <div className="d-flex justify-content-center">
                <Button type="submit" color="info" className="VP_Comment_static_Update_button_white" outline>Update</Button>
            </div>
        </div>
    );
};
export default MyCommentsEditProfile1White;