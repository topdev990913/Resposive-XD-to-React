...
const VPSubscriberCard2 = ({checkedSubscriber, setCheckedSubscriber}) => {
    return (
        <div className="VPSubscriberCard_out">
            ...
            <div className="VPSubscriberCard_2_2" style={{ marginLeft: "55.1px" }}>
                Ended
            </div>
        </div>
    );
};
export default VPSubscriberCard2;
