...
import ModalRenewWhite from "../../ModalRenewWhite";
const VPSubscriptionCard1White = ({ checkedSubscriber, setCheckedSubscriber }) => {
    ...
    return (
        <div className="VPSubscriberCard_out_white">
            ...
            <div className="VPSubscriberCard_2_3_white" onClick={handleShow} style={{ marginLeft: "100.1px" }}>
                Renew
            </div>
            <Modal show={show} onHide={handleClose} dialogClassName="modal_out1" id="Renew_white">
                <ModalRenewWhite />
            </Modal>
        </div>
    );
};
export default VPSubscriptionCard1White;
