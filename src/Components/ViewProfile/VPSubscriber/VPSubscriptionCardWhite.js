...
const VPSubscriptionCardWhite = ({ checkedSubscriber, setCheckedSubscriber }) => {
    return (
        <div className="VPSubscriberCard_out_white">
            ...
            <div className="VPSubscriberCard_2_white" style={{ marginLeft: "55.1px" }}>
                Active
            </div>
        </div>
    );
};
export default VPSubscriptionCardWhite;
