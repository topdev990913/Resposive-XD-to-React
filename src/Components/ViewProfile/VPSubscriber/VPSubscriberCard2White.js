...
const VPSubscriberCard2White = ({checkedSubscriber, setCheckedSubscriber}) => {
    return (
        <div className="VPSubscriberCard_out_white">
            ...
            <div className="VPSubscriberCard_2_2_white" style={{ marginLeft: "55.1px" }}>
                Ended
            </div>
        </div>
    );
};
export default VPSubscriberCard2White;
