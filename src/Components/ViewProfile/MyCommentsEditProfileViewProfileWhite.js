...
const MyCommentsEditProfileViewProfileWhite = ({ checkedBall, setCheckedBall }, { checkedViewProfile, setCheckedViewProfile }) => {
    return (
        <div className="VP_MC_EP_out_white">
            ...
            <div className="d-flex justify-content-center" style={{marginTop: "8px"}}>
                <div className="d-flex align-items-center">
                    <div className="VPVP_1_white">
                        Month
                    </div>
                    <div className="VPVP_2_white">
                        /29.90
                    </div>
                    <div className="VPVP_3" style={{marginLeft: "5px"}}>
                        ₺
                    </div>
                    <Button type="submit" className="VPVP_Subscribe_button_white" outline>Subscribe</Button>
                </div>
            </div>
        </div>
    );
};
export default MyCommentsEditProfileViewProfileWhite;