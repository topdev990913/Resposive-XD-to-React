...
import VPRightBarSub4CardLogo2 from '../../assets/Path 673.png';
const VPRightBarSub4Card3White = () => {
    return (
        <div className="VPRightBarSub4Card_out">
            ...
            <div className="VPRightBarSub4Card_2_2_white">
                Other
            </div>
        </div>
    );
};
export default VPRightBarSub4Card3White;